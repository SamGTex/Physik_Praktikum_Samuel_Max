...
#Werte
theta, N = np.genfromtxt('data/Zink.dat', delimiter=',', unpack=True)
Z = 30 #Ordnungszahl
t = 20 #s
...
theta_k = 18.7 #Grad (abgeschaetzt)
I_k = 84 #Imps/s (abgeschaetzt)
...
#R_ber = E_k/(h*(Z-sigma_k)**2)
#R_inf_ber = h * R_ber
#print('R =',R_ber)
#print('R_inf =',R_inf_ber)
#print('R_inf_th =',R_inf)
#print('Abweichung:',(R_inf-R_inf_ber)*100/R_inf)
