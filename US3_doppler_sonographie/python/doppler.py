...
#Plots
plt.subplot(3,1,1)
plt.plot(N[:5], delta_f[:5]/(np.cos(alpha[:5])*1000),'rx', label=r'$15\degree$')
plt.xlabel(r'$N \,/\, rpm$')
plt.ylabel(r'$\frac{\Delta \nu}{\cos{\alpha}}\, /\, Hz$')
plt.grid()
plt.legend()
plt.subplot(3,1,2)
plt.plot(N[5:10], delta_f[5:10]/(np.cos(alpha[5:10])*1000),'gx', label=r'$30\degree$')
plt.xlabel(r'$N \,/\, rpm$')
plt.ylabel(r'$\frac{\Delta \nu}{\cos{\alpha}}\, /\, Hz$')
plt.legend()
plt.grid()
plt.subplot(3,1,3)
plt.plot(N[10:], delta_f[10:]/(np.cos(alpha[10:])*1000),'bx', label=r'$45\degree$')
plt.xlabel(r'$N \,/\, rpm$')
plt.ylabel(r'$\frac{\Delta \nu}{\cos{\alpha}}\, /\, Hz$')
plt.grid()
plt.legend()
