...
Zu diesem Wert tritt der aperiodische Grenzfall auf. Der theoretische Wert der nach \eqref{eqn:aperiodisch} berechnet wurde, beträgt $\SI{5723.3977}{\kilo\ohm}$.
...
Die Grafik \ref{fig:spannung_log} und \ref{spannung_lin} zeigen die Spannung in Abhängigkeit vom der Frequenz am Kondensator.
...
\begin{equation*}
    f_{\text{theo}+}- f_{\text{theo}-} = \SI{40142.264(2000.000)}{\hertz}
\end{equation*}
berechnet.
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{content/data/plotc2.pdf}
...
\begin{figure}
        \centering
        \includegraphics[width=\textwidth]{content/data/plotd2.pdf}
