...
\begin{tabular}{cc|cc}
  \toprule
  $x \:/\: \si{\centi\metre}}$ & $B \:/\: \si{\milli\tesla}$ & $x \:/\: \si{\centi\metre}}$ & $B \:/\: \si{\milli\tesla}$ \\
  \midrule
  -2.5 & 0.134 &  6 & 2.148  \\
  -2 & 0.162 & 12.5 & 2.203 \\
  -1.5 & 0.2 &  13 & 2.182 \\
...
Da aus technsichen Gründen das Magnetfeld in der Mitte der Spule nicht gemessen werden konnte, wird Näherungsweise der Messerte bei $6 \si{\centi\metre}}$ genommen.
\begin{equation*}
  B(6\si{\centi\metre}}) = 2.148 \si{\milli\tesla} 
\end{equation*}
...
\begin{figure}
\centering
\includegraphics{contant/data/plot_helmholtz1.pdf}
...
\begin{figure}
\centering
\includegraphics{contant/data/plot_helmholtz2.pdf}
...
\begin{figure}
\centering
\includegraphics{contant/data/plot_helmholtz3.pdf}
