...
\caption{B-Feld in Abhängikeit vom Ort $x$ mit dem Spulenabstand $d_1=\SI{11}{\centi\metre}$. }
\label{fig:helm1}
\end{figure}
...
\caption{B-Feld in Abhängikeit vom Ort $x$ mit dem Spulenabstand $d_2=\SI{7}{\centi\metre}$.}
\label{fig:helm2}
\end{figure}
...
\caption{B-Feld in Abhängikeit vom Ort $x$ mit dem Spulenabstand $d_3=\SI{15}{\centi\metre}$.}
\label{fig:helm3}
\end{figure}
