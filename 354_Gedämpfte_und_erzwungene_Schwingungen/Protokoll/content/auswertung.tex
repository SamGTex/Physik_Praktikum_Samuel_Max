...
Zu diesem Wert tritt der aperiodische Grenzfall auf.  
...
\begin{figure}
    \centering
    \centering
    \includegraphics[height=3cm]{content/data/plotd.pdf}
...
\begin{figure}
        ...
        \label{fig:phase_lin}
    \caption{Der berechnete Phasenunterschied zu den aufgenommen Frequenzen.}
\end{figure}
